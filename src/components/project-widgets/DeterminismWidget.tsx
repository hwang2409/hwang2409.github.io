...
export default function DeterminismWidget() {
  ...
  return (
    <section className={`project-widget ${styles.chaos}`} aria-label="deterministic replay and sensitive initial conditions">
      ...
      <p className="project-widget-note">40 simulated seconds. the plot shows angular separation on a log scale; steady upward stretches show exponential growth. exact agreement sits at the plot floor. static preview shows the perturbed end state; [step] starts from rest.</p>
    </section>
  );
}
