  ...
  return (
    <>
      <section className="home-intro" aria-labelledby="home-name">
        ...
        <p>swe @ uwaterloo, interested in computer graphics, ML systems, and small technical tools. currently engineering at <a href="https://phoebe.work/" target="_blank" rel="noopener noreferrer">phoebe</a>; previously <a href="https://fish.audio" target="_blank" rel="noopener noreferrer">fish audio</a> and <a href="https://www.nationgraph.com/" target="_blank" rel="noopener noreferrer">nationgraph</a>.</p>
      </section>
